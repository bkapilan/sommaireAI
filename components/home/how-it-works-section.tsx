import { BrainCircuit, FileOutput, FileText, Move, MoveRight } from "lucide-react";
            ...
            <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                <div
                    ...
                    <div
                        ...
                        bg-linear-to-br from-emerald-500 via-teal-500 to-cyan-500 opacity-20 sm:left-[calc(40%+30rem)]
                        sm:w-[40.1875rem]"
                        style={{
...
function StepItem({ icon, label, description }: Step) { 
    return <div className="relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs border
     border-white/10 hover:border-rose-500/50 transition-colors group w-full">
